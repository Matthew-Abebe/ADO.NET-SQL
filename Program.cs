...
namespace DepartmentsEmployees
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            // Here an instance of Repository class is created so we can use it's methods
            Repository repository = new Repository(); 

           // This is a List of type Department called departments. It is set equal to a method from repository called GetAllDepartments();
        ...
        public static void PrintEmployeeReport(string title, List<Employee> employees)
        {
            ...
            employees.ForEach(emp => Console.WriteLine($"{emp.Id}: {emp.FirstName} {emp.LastName}. Dept: {emp.Department.DeptName}"));
        }
